...
try:
    ...
    logger.warning(f"3D visualization not available: {e}")
    VISPY_AVAILABLE = False


class Simple3DViewer(QWidget):
    """Simple 3D model viewer using vispy"""
    ...
    def __init__(self, width=496, height=460, is_session_viewer=False):  # Updated default size to match model cards
        super().__init__()
...
class Model3DPreviewCard(QFrame):
    ...
    def __init__(self, model_path: Path, is_session_viewer=False):
        ...
        # Match image card design exactly
